...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cluster.setText(_translate("MainWindow", "Show Cluster"))
        self.cluster_2.setText(_translate("MainWindow", "Show Cluster"))
        self.cluster_3.setText(_translate("MainWindow", "Show Cluster"))
        self.cluster_4.setText(_translate("MainWindow", "Show Cluster"))
